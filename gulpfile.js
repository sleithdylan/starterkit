...
gulp.task('server', function() {
	...
	gulp.watch(PATHS.src + '/{data,helpers,layouts,pages,partials}/**/*', [
		'watch-html'
	]);
	...
	gulp.watch(PATHS.src_img + '/svgs/**/*.svg', ['sprites']);
});
